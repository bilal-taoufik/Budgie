...
<head>
    ...
    <title>Reinitialisez votre mot de passe Budgie</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px; border:1px solid #2d3431; border-radius:24px; background:#0b0d0c; overflow:hidden;">
                    <tr>
                        <td style="padding:36px 32px 20px 32px; text-align:center;">
                            ...
                            <p style="margin:0 0 10px 0; color:#85A795; font-size:13px; font-weight:700; letter-spacing:.08em; text-transform:uppercase;">Securite</p>
                            <h1 style="margin:0; color:#ffffff; font-size:30px; line-height:1.2; font-weight:800;">Nouveau mot de passe</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:8px 32px 0 32px;">
                            ...
                            <p style="margin:0 0 18px 0; color:#d7dfdb; font-size:16px; line-height:1.7;">Une demande de reinitialisation a ete effectuee pour votre compte Budgie. Utilisez le bouton ci-dessous pour choisir un nouveau mot de passe.</p>
                        </td>
                    </tr>

                    <tr>
                        <td align="center" style="padding:14px 32px 28px 32px;">
                            <a href="{{ $resetUrl }}" style="display:inline-block; padding:15px 28px; border-radius:999px; background:#b9c9cb; color:#050606; font-size:14px; font-weight:800; text-decoration:none;">Reinitialiser mon mot de passe</a>
                        </td>
                    </tr>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-top:1px solid #2d3431;">
                                <tr>
                                    <td style="padding-top:22px;">
                                        <p style="margin:0 0 12px 0; color:#99a39f; font-size:14px; line-height:1.6;">Ce lien expire dans {{ $expirationMinutes }} minutes. Si le bouton ne fonctionne pas, copiez ce lien :</p>
                                        <p style="margin:0; color:#85A795; font-size:13px; line-height:1.6; word-break:break-all;">{{ $resetUrl }}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:0 32px 36px 32px;">
                            <p style="margin:0; color:#7f8985; font-size:13px; line-height:1.6;">Si vous n'etes pas a l'origine de cette demande, ignorez cet e-mail. Votre mot de passe actuel restera inchange.</p>
                        </td>
                    </tr>
                </table>
