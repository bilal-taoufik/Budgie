            ...
            <div class="dashboard-page">
                <div class="dashboard-sidebar">
                    ...
                    <nav class="dashboard-nav">
                        ...
                        <a href="{{ route('customer.depenses.index') }}" class="nav-link"><span>Depenses</span></a>
                        <a href="{{ route('customer.revenues.index') }}" class="nav-link is-active"><span>Revenus</span></a>
                        ...
                        <div class="client-section">
                            ...
                            <div class="entity-grid">
                                @forelse($transactions as $transaction)
                                    <div class="dashboard-card entity-card">
                                        ...
                                        <details class="entity-edit">
                                            ...
                                            <form class="dashboard-form" method="POST" action="{{ route('customer.revenues.update', $transaction) }}">
                                                @csrf
                                                @method('PUT')
                                                <input type="hidden" name="type" value="revenu">
                                        ...
                                        <div class="entity-actions">
                                            <form method="POST" action="{{ route('customer.revenues.delete', $transaction) }}" data-confirm="Supprimer cette transaction ?">
                                                @csrf
                                                @method('DELETE')
                                ...
                                @empty
                                    <div class="dashboard-card entity-card"><p class="text-color-body">Aucun revenu pour le moment.</p></div>
                                @endforelse
                            </div>
                        </div>
                    </div>
