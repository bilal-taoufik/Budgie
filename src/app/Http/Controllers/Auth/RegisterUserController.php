...
class RegisterUserController extends Controller
{
    ...
    public function store(RegisterRequest $request)
    {
        try {
            ...
            // supprimer l'utilisateur si erreur
            if (isset($user)) {
                $user->delete();
            }

            //dd($erreur->getMessage());
            return redirect()->route('register')->with('error', 'Une erreur est survenue lors de l\'inscription. Veuillez réessayer.');
        }
    }
}