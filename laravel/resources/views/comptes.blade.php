            ...
            <div class="dashboard-page">
                <aside class="dashboard-sidebar">
                    ...
                    <nav class="dashboard-nav">
                        ...
                        <a href="{{ route('comptes') }}" class="nav-link is-active">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="{{ route('depenses') }}" class="nav-link">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="{{ route('revenus') }}" class="nav-link">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="{{ route('previsions') }}" class="nav-link">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <main class="dashboard-main">
                    <header class="dashboard-header">
                        ...
                        <a class="client-back-link" href="{{ route('dashboard') }}">Retour au dashboard</a>
                    </header>
