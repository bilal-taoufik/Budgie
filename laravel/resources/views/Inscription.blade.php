                ...
                <div class="padding-global padding-section-large">
                    <div class="component-form">
                        ...
                        <div class="form-block w-form">
                            ...
                            <form id="signup-form" method="POST" action="{{ route('client.inscription.store') }}">
                                @csrf
                                <div class="form-field-wrapper">
                                    <input 
                                        ...
                                        pattern="[A-Za-zÀ-ÿ\s'-]+"
                                        placeholder="Nom*"
                                        title="Le nom doit contenir uniquement des lettres, espaces, apostrophes ou tirets."
                                        required
                                    >
                                </div>
                                <div class="form-field-wrapper">
                                    <input 
                                        ...
                                        pattern="[A-Za-zÀ-ÿ\s'-]+"
                                        placeholder="Prénom*"
                                        title="Le prénom doit contenir uniquement des lettres, espaces, apostrophes ou tirets."
                                        required
                                    >
                                </div>
                                <div class="form-field-wrapper">
                                ...
                                <div class="form-field-wrapper">
                                    <input 
                                        ...
                                        title="Le téléphone doit contenir uniquement des chiffres et peut commencer par +."
                                        required
                                    >
                                </div>
                                <div class="form-field-wrapper">
