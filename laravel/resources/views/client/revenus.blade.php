            ...
            <div class="dashboard-page">
                <aside class="dashboard-sidebar">
                    ...
                    <nav class="dashboard-nav">
                        ...
                        <a href="/client/comptes" class="nav-link">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="/client/revenus" class="nav-link is-active">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <main class="dashboard-main">
                    <header class="dashboard-header">
                        <div>
                            ...
                            <p class="text-color-body text-size-small">Créer, modifier, supprimer et afficher vos revenus.</p>
                        </div>
                    ...
                    <section class="dashboard-content client-sections-content">
                        <section class="client-section">
                            <div class="client-section-heading">
                                <button type="button" class="dashboard-action-button">Créer un revenu</button>
                            </div>

                            <div class="entity-grid">
                                <article class="dashboard-card entity-card">
                                    <span class="entity-badge">Tous les 1 mois</span>
                                    <h3 class="heading-style-h5-bold">Alimentation CTO</h3>
                                    <p class="text-color-body">Alimentation mensuelle du compte titre ordinaire</p>
                                    <dl class="entity-details">
                                        <div><dt>Compte</dt><dd>Compte Titre Ordinaire</dd></div>
                                        <div><dt>Montant</dt><dd>50 €</dd></div>
                                        <div><dt>Date de début</dt><dd>01/01/2025</dd></div>
                                        <div><dt>Date de fin</dt><dd>31/12/2025</dd></div>
                                    </dl>
                                ...
                                <article class="dashboard-card entity-card">
                                    <span class="entity-badge">Tous les 1 mois</span>
                                    <h3 class="heading-style-h5-bold">Salaire</h3>
                                    <p class="text-color-body">Salaire Alternant Développeur Web</p>
                                    <dl class="entity-details">
                                        <div><dt>Compte</dt><dd>Compte courant</dd></div>
                                        <div><dt>Montant</dt><dd>1 170 €</dd></div>
                                        <div><dt>Date de début</dt><dd>01/01/2025</dd></div>
                                        <div><dt>Date de fin</dt><dd>31/12/2027</dd></div>
                                    </dl>
                                    <div class="entity-actions">
                                        <button type="button">Modifier</button>
                                        <button type="button">Supprimer</button>
                                ...
                                <article class="dashboard-card entity-card">
                                    <span class="entity-badge">Tous les 12 mois</span>
                                    <h3 class="heading-style-h5-bold">Prime</h3>
                                    <p class="text-color-body">Prime de fin d'année</p>
                                    <dl class="entity-details">
                                        <div><dt>Compte</dt><dd>Compte courant</dd></div>
                                        <div><dt>Montant</dt><dd>150 €</dd></div>
                                        <div><dt>Date de début</dt><dd>01/01/2025</dd></div>
                                        <div><dt>Date de fin</dt><dd>31/12/2027</dd></div>
                                    </dl>
                                    <div class="entity-actions">
