        ...
        <div class="page-wrapper">
            <div class="dashboard-page">
                <aside class="dashboard-sidebar">
                    <a href="/" class="dashboard-logo" aria-label="Accueil">
                    ...
                    <nav class="dashboard-nav">
                        ...
                        <a href="/client/comptes" class="nav-link is-active">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="/client/depenses" class="nav-link">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="/client/revenus" class="nav-link">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="/client/previsions" class="nav-link">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="dashboard-sidebar-bottom">
                        <a href="/client/profil" class="nav-link">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <main class="dashboard-main">
                    <header class="dashboard-header">
                        <div>
                            ...
                            <p class="text-color-body text-size-small">Créer, modifier, supprimer et afficher vos comptes.</p>
                        </div>
                        <a class="client-back-link" href="/client/dashboard">Retour au dashboard</a>
                    </header>

                    <section class="dashboard-content client-sections-content">
                        <section class="client-section">
                            <div class="client-section-heading">
                                <button type="button" class="dashboard-action-button">Créer un compte</button>
                            </div>

                            <div class="dashboard-table-card dashboard-card">
                                <div class="dashboard-filter-row">
                                    <label for="account-search">Filtrer par nom ou description</label>
                                    <input id="account-search" type="search" placeholder="Ex : Livret A">
                                </div>
                                    ...
                                    <table class="dashboard-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Compte courant individuel</td>
                                                <td>01/01/2005</td>
                                                <td>0%</td>
                                                <td>0%</td>
                                                <td>22 500,00 €</td>
                                                <td><span class="table-actions">Modifier · Supprimer</span></td>
                                            </tr>
                                            <tr>
                                                <td>Livret A</td>
                                                <td>Livret A individuel</td>
                                                <td>01/01/2010</td>
                                                <td>1,7%</td>
                                                <td>0%</td>
                                                <td>8 750,00 €</td>
                                            ...
                                            <tr>
                                                <td>Compte Titre Ordinaire</td>
                                                <td>Compte d'investissement individuel</td>
                                                <td>01/01/2010</td>
                                                <td>7%</td>
                                                <td>30%</td>
                                                <td>6 750,00 €</td>
                            ...
                            <article class="dashboard-card entity-form-card">
                                <h3 class="heading-style-h5-bold">Formulaire compte</h3>
                                <form class="dashboard-form">
                                    <label>Nom court<input type="text" value="Livret A"></label>
                                    <label>Description<input type="text" value="Livret A individuel"></label>
                                    <label>Date de création<input type="date" value="2010-01-01"></label>
                                    <label>Taux de rémunération annuel<input type="text" value="1,7%"></label>
                                    <label>Taux d'imposition<input type="text" value="0%"></label>
                                    <button type="button" class="dashboard-action-button">Enregistrer</button>
                                </form>
                            </article>
                        </section>
                    </section>
