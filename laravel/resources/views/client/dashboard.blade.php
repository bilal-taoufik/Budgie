...
<head>
    ...
    <script type="module" src="/src/js/chart.js"></script>
            ...
            <div class="dashboard-page">
                <aside class="dashboard-sidebar">
                    ...
                    <nav class="dashboard-nav">
                        <a href="/client/dashboard" class="nav-link is-active">
                    ...
                    <header class="dashboard-header">
                        <div>
                            ...
                            <p class="text-color-body text-size-small">
                                Bienvenue sur Budgie, votre partenaire financier personnel
                            </p>
                        </div>
                    ...
                    <section class="dashboard-content" id="dashboard-overview">
                        <div class="dashboard-stats">
                            <article class="dashboard-card stat-card">
                                <div>
                                    ...
                                    <h2 class="heading-style-h3-regular">22 500,00 €</h2>
                            ...
                            <article class="dashboard-card stat-card">
                                <div>
                                    <div class="margin-bottom margin-small">
                                        <span class="text-size-regular">Revenus mensuels</span>
                                    </div>
                                    <h2 class="heading-style-h3-regular">+1 170,00 €</h2>
                                    <p class="text-color-body text-size-small">Salaires et revenus</p>
                                </div>
                            </article>
                            ...
                            <article class="dashboard-card stat-card">
                                <div>
                                    <div class="margin-bottom margin-small">
                                        <span class="text-size-regular">Dépenses mensuelles</span>
                                    </div>
                                    <h2 class="heading-style-h3-regular">-335,00 €</h2>
                                    <p class="text-color-body text-size-small">Dépenses totales</p>
                                </div>
                            </article>
                        </div>
                        ...
                        <article class="dashboard-card transactions-card">
                            <div class="dashboard-card-header">
                                ...
                                <a href="/client/depenses">Voir tout</a>
                            </div>

                            <div class="transaction-row">
                                <div>
                                    <p class="text-size-regular text-weight-medium">Salaire</p>
                                    <span class="text-size-tiny text-color-body">Tous les 1 mois</span>
                                </div>
                                <p class="positive text-weight-bold">+1 170,00 €</p>
                            </div>

                            <div class="transaction-row">
                                <div>
                                    <p class="text-size-regular text-weight-medium">Crédit Moto</p>
                                    <span class="text-size-tiny text-color-body">Tous les 1 mois</span>
                                </div>
                                <p class="negative text-weight-bold">-250,00 €</p>
                            </div>
                        </article>
                    </section>
                </main>
