            ...
            <div class="dashboard-page">
                <aside class="dashboard-sidebar">
                    ...
                    <div class="dashboard-sidebar-bottom">
                        <a href="/client/profil" class="nav-link is-active">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <section class="client-section">
                            <article class="dashboard-card entity-form-card">
                                <form class="dashboard-form">
                                    <label>Nom<input type="text" value="Bilal"></label>
                                    <label>Email<input type="email" value="bilal@budgie.fr"></label>
                                    <label>Mot de passe<input type="password" autocomplete="new-password" placeholder="Nouveau mot de passe"></label>
                                    <button type="button" class="dashboard-action-button">Mettre à jour</button>
                                </form>
                            </article>
                        </section>
                    </section>
