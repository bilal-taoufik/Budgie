            ...
            <div class="dashboard-page">
                <aside class="dashboard-sidebar">
                    ...
                    <nav class="dashboard-nav">
                        ...
                        <a href="/client/depenses" class="nav-link is-active">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <main class="dashboard-main">
                    <header class="dashboard-header">
                        <div>
                            ...
                            <p class="text-color-body text-size-small">Créer, modifier, supprimer et afficher vos dépenses.</p>
                        </div>
                    ...
                    <section class="dashboard-content client-sections-content">
                        <section class="client-section">
                            <div class="client-section-heading">
                                <button type="button" class="dashboard-action-button">Créer une dépense</button>
                            </div>

                            <div class="entity-grid">
                                <article class="dashboard-card entity-card">
                                    <span class="entity-badge">Tous les 1 mois</span>
                                    <h3 class="heading-style-h5-bold">Crédit Moto</h3>
                                    <p class="text-color-body">Crédit pour la Triumph Tiger 660 Sport 2023</p>
                                    <dl class="entity-details">
                                        <div><dt>Compte</dt><dd>Compte courant Société Générale</dd></div>
                                        <div><dt>Montant</dt><dd>250 €</dd></div>
                                        <div><dt>Date de début</dt><dd>01/01/2023</dd></div>
                                        <div><dt>Date de fin</dt><dd>31/12/2028</dd></div>
                                    </dl>
                                ...
                                <article class="dashboard-card entity-card">
                                    <span class="entity-badge is-once">Ponctuel</span>
                                    <h3 class="heading-style-h5-bold">iPhone 19</h3>
                                    <p class="text-color-body">iPhone 19 Pro Max Limited Hanna Montana Edition</p>
                                    <dl class="entity-details">
                                        <div><dt>Compte</dt><dd>Compte courant Société Générale</dd></div>
                                        <div><dt>Montant</dt><dd>4 321 €</dd></div>
                                        <div><dt>Date de début</dt><dd>01/09/2025</dd></div>
                                        <div><dt>Date de fin</dt><dd>N/A</dd></div>
                                    </dl>
                                    <div class="entity-actions">
                                        <button type="button">Modifier</button>
                                        <button type="button">Supprimer</button>
