            ...
            <div class="dashboard-page">
                <aside class="dashboard-sidebar">
                    ...
                    <nav class="dashboard-nav">
                        ...
                        <a href="/client/previsions" class="nav-link is-active">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <main class="dashboard-main">
                    <header class="dashboard-header">
                        <div>
                            ...
                            <p class="text-color-body text-size-small">Consulter l'état des comptes à une date sélectionnée.</p>
                        </div>
                            ...
                            <div class="forecast-layout">
                                <article class="dashboard-card entity-form-card">
                                    ...
                                    <form class="dashboard-form">
                                        <label>
                                            Mois sélectionné
                                            <input type="month" value="2035-12">
                                        </label>
                                        <button type="button" class="dashboard-action-button">Calculer la prévision</button>
                                    </form>
                                </article>

                                <article class="dashboard-card forecast-summary">
                                    <h3 class="heading-style-h5-bold">Prévision au 31/12/2035</h3>
                                    <p class="text-color-body">Solde net projeté avec les dépenses, revenus et intérêts mensuels des comptes rémunérés.</p>
                                    <div class="forecast-total">58 940,00 €</div>
                                    <div class="forecast-list">
                                        <div><span>Société Générale</span><strong>18 420,00 €</strong></div>
                                        <div><span>Livret A</span><strong>16 880,00 €</strong></div>
                                        <div><span>Compte Titre Ordinaire</span><strong>23 640,00 €</strong></div>
                                    </div>
                                </article>
                            </div>
                        </section>
